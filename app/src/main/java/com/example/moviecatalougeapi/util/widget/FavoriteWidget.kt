...
class FavoriteWidget : AppWidgetProvider() {
    ...
    companion object {
        const val UPDATE_WIDGET = "com.example.moviecatalougeapi.UPDATE_WIDGET"
        private const val TOAST_ACTION = "com.example.moviecatalougeapi.TOAST_ACTION"
        const val EXTRA_ITEM = "com.example.moviecatalougeapi.EXTRA_ITEM"
